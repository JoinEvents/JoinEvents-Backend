...
namespace EventEase.Application.Auth
{
    public class Dtos
    {
        ...
        public record UserProfileDto(Guid id, string name, string email, string phone, string city, string address, string bio, string joinedDate, string accountStatus, int loyaltyPoints, string loyaltyTier, string? referralCode, bool emailNotifications, bool inAppNotifications, bool smsNotifications, string? avatar, string? businessName = null, string? description = null);
