...
{
    /// <summary>
    /// Target model for <see cref="AddMissingBookingAndTicketColumns"/>.
    /// </summary>
    /// <remarks>
    /// Taken verbatim from EventEaseDbContextModelSnapshot, which already described the model
    /// this migration brings the database up to. Normally the tooling writes this file; it is
    /// written here because the migration itself was, and the two must agree.
    /// </remarks>
    [DbContext(typeof(EventEaseDbContext))]
    [Migration("20260921040000_AddMissingBookingAndTicketColumns")]
    partial class AddMissingBookingAndTicketColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventEase.Core.Entities.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("EventEase.Core.Entities.Booking", b =>
                {
                    ...
                    b.Property<decimal>("PlatformCancellationFeeRetained")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("VendorPenaltyAmount")
                        .HasColumnType("decimal(18,2)");

                    b.Property<bool>("VendorStrikeApplied")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("EventEase.Core.Entities.BookingService", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EventEase.Core.Entities.VendorBlockedDate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("VendorId", "BlockedDate")
                        .IsUnique();
            ...
            modelBuilder.Entity("EventEase.Core.Entities.BookingService", b =>
                {
                    b.HasOne("EventEase.Core.Entities.Booking", null)
                        .WithMany()
